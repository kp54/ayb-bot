...
package openapi
// InlineResponse2004Local struct for InlineResponse2004Local
type InlineResponse2004Local struct {
	Followings InlineResponse2004LocalFollowings `json:"followings"`
	Followers InlineResponse2004LocalFollowers `json:"followers"`
}
