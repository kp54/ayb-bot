...
@return []Notification
*/
func (a *NotificationsApiService) INotifications(ctx _context.Context, inlineObject80 InlineObject80) ([]Notification, *_nethttp.Response, error) {
	var (
 ...
 * @param body
*/
func (a *NotificationsApiService) NotificationsMarkAllAsRead(ctx _context.Context, body map[string]interface{}) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
 ...
 * @param body
*/
func (a *NotificationsApiService) NotificationsMarkAllAsRead_1(ctx _context.Context, body map[string]interface{}) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
