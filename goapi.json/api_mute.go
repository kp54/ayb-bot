...
*/
func (a *MuteApiService) MuteCreate(ctx _context.Context, inlineObject90 InlineObject90) (*_nethttp.Response, error) {
	var (
...
*/
func (a *MuteApiService) MuteDelete(ctx _context.Context, inlineObject91 InlineObject91) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return []Muting
*/
func (a *MuteApiService) MuteList(ctx _context.Context, inlineObject92 InlineObject92) ([]Muting, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
