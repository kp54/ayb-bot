...
type InlineResponse2007 struct {
	// The version of Misskey of this instance.
	Version string `json:"version"`
	// The name of this instance.
	Name string `json:"name"`
	// The description of this instance.
	Description string `json:"description"`
	// The announcements of this instance.
	Announcements []InlineResponse2007Announcements `json:"announcements"`
	// Whether disabled open registration.
	DisableRegistration bool `json:"disableRegistration"`
	// Whether disabled LTL and STL.
	DisableLocalTimeline bool `json:"disableLocalTimeline"`
	// Whether disabled GTL.
	DisableGlobalTimeline bool `json:"disableGlobalTimeline"`
	// Whether the instance policy prohibits to fetch notes marked as local only via unauthenticated APIs.
	ProtectLocalOnlyNotes bool `json:"protectLocalOnlyNotes"`
	// Whether enabled emoji reaction.
	EnableEmojiReaction bool `json:"enableEmojiReaction"`
}
