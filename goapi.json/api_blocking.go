...
*/
func (a *BlockingApiService) BlockingCreate(ctx _context.Context, inlineObject31 InlineObject31) (*_nethttp.Response, error) {
	var (
...
*/
func (a *BlockingApiService) BlockingDelete(ctx _context.Context, inlineObject32 InlineObject32) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return []Blocking
*/
func (a *BlockingApiService) BlockingList(ctx _context.Context, inlineObject33 InlineObject33) ([]Blocking, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
