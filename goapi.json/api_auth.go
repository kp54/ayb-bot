...
*/
func (a *AuthApiService) AuthSessionGenerate(ctx _context.Context, inlineObject28 InlineObject28) (InlineResponse200, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/auth/session/generate"
...
*/
func (a *AuthApiService) AuthSessionShow(ctx _context.Context, inlineObject29 InlineObject29) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/auth/session/show"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
*/
func (a *AuthApiService) AuthSessionUserkey(ctx _context.Context, inlineObject30 InlineObject30) (InlineResponse2001, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/auth/session/userkey"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
