...
type InlineResponse2009 struct {
	// The count of all (local/remote) notes of this instance.
	NotesCount float32 `json:"notesCount"`
	// The count of all local notes of this instance.
	OriginalNotesCount float32 `json:"originalNotesCount"`
	// The count of all (local/remote) accounts of this instance.
	UsersCount float32 `json:"usersCount"`
	// The count of all local accounts of this instance.
	OriginalUsersCount float32 `json:"originalUsersCount"`
	// The count of federated instances.
