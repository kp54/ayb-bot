...
package openapi
// InlineResponse2007Announcements struct for InlineResponse2007Announcements
type InlineResponse2007Announcements struct {
	// The title of the announcement.
	Title string `json:"title"`
	// The text of the announcement. (can be HTML)
