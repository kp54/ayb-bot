...
*/
func (a *AppApiService) AppCreate(ctx _context.Context, inlineObject26 InlineObject26) (*_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/app/create"
...
*/
func (a *AppApiService) AppShow(ctx _context.Context, inlineObject27 InlineObject27) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/app/show"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
*/
func (a *AppApiService) MyApps(ctx _context.Context, inlineObject93 InlineObject93) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
